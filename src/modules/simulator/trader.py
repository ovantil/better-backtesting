...
class Trader:
    ...
    def __init__(self,
        ...
        self.spot_df[
            'bullish_candle'] = self.spot_df['open'] < self.spot_df['close']
        self.spot_df[
            'bearish_candle'] = self.spot_df['open'] > self.spot_df['close']
    ...
    def simulate(self):
        ...
        for index, row in enumerate(entry_points.itertuples()):
            ...
            bullish_candles = self.spot_df.iloc[row.Index - 8:row.
                                                Index]['bullish_candle'].sum()
        ...
        for trade in self.trades:
            if trade.exit_timestamp != None:
                ...
                print(f'entry ts: [{trade.entry_timestamp}]')
                print(f'exit ts: [{trade.exit_timestamp}]')
